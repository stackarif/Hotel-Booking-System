    ...
    {   
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                    ...
                    return dropdownModalButtonWithDetails($editLink, $deleteLink, $showLink);
                    })
                    ...
                    ->addColumn('checkbox', function ($user) {
                        return '<input type="checkbox" id="'.$user->id.'" name="checkbox" class="form-check-input"/>';
                      })
                    ->escapeColumns('status','name','checkbox')
                    ->rawColumns(['action'])
                    ->make(true);
        }
