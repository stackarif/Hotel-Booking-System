...
if (!function_exists('dropdownModalButton')) {
     ...
     * 
     */
    function dropdownModalButton($edit = '', $delete = '')
    {  
        $btn = '
            <div class="d-flex align-items-center">
                <div class="dropdown"><a href="javascript:;" class="btn dropdown-toggle hide-arrow text-body p-0" data-bs-toggle="dropdown" aria-expanded="false"><i class="bx bx-dots-vertical-rounded"></i></a>
                <div class="dropdown-menu dropdown-menu-end" style="">
                    <button data-toggle="modal" data-target="#myDynamicModal" data-link="'.$edit.'" class="dropdown-item ajax-modal-btn">'.trans('sentence.edit').'</button>
                    <form method="POST" action="'. $delete .'">
                    <input type="hidden" name="_token" id="csrf-token" value="'.csrf_token().'" />
                    <button type="submit" class="dropdown-item delete-record text-danger show_confirm" data-toggle="tooltip" title="Delete">'.trans('sentence.delete').'</button>
                    </form>
...
if (!function_exists('dropdownModalButtonWithDetails')) {
     ...
     * 
     */
    function dropdownModalButtonWithDetails($edit = '', $delete = '', $show = '')
    {  
        $btn = '
            <div class="d-flex align-items-center">
                <div class="dropdown"><a href="javascript:;" class="btn dropdown-toggle hide-arrow text-body p-0" data-bs-toggle="dropdown" aria-expanded="false"><i class="bx bx-dots-vertical-rounded"></i></a>
                <div class="dropdown-menu dropdown-menu-end" style="">
                    <button data-toggle="modal" data-target="#myDynamicModal" data-link="'.$edit.'" class="dropdown-item ajax-modal-btn">'.trans('sentence.edit').'</button>
                    <button data-toggle="modal" data-target="#myDynamicModal" data-link="'.$show.'" class="dropdown-item ajax-modal-btn">'.trans('sentence.details').'</button>
                    <form method="POST" action="'. $delete .'">
                    <input type="hidden" name="_token" id="csrf-token" value="'.csrf_token().'" />
                    <button type="submit" class="dropdown-item delete-record text-danger show_confirm" data-toggle="tooltip" title="Delete">'.trans('sentence.delete').'</button>
                    </form>
    ...
    function selected_theme()
    {
        ...
        if($theme === 'semi_dark') {
            return '.bg-menu-theme{
                ...
                .menu-item .menu-sub>.menu-item>.active {
